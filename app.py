...
app.config['MAIL_USERNAME'] = 'Owens.shanna0@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'wlknufginboxwswe'  # Your Gmail password or App Password

...
app.config['MAIL_USERNAME'] = 'Maria.watersideproperties@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'zcfkwgzouahkwamp'  # Your Gmail password or App Password
